 ...
 */
public class DirectionRequest extends StringRequest {
    private Map<String, String> params;
    private static final String DURATION_REQUEST_URL = "php/Direction.php";

    public DirectionRequest(double lat, double lng, double dlat, double dlng, Response.Listener<String> listener, Response.ErrorListener errorListener, String url) {
