...
public class AlarmReceiver1 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        locale = new UserLocalStore(context);
         NotificationCompat.Builder mBuilder =
                    new NotificationCompat.Builder(context)
                          ...
                          .setContentText(context.getResources().getString(R.string.alarm30));

        int mNotificationId = 11556;
        ...
        Intent alintent = new Intent(context, AlarmReceiver1.class);
        PendingIntent alarmIntent = PendingIntent.getBroadcast(context, 22231, alintent, PendingIntent.FLAG_UPDATE_CURRENT);
