 ...
 */
public class sms_dialog extends DialogFragment {
Button done;
    EditText code;
    int i=0;
    Handler handler;
  TextView progress;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SmsReceiver.bindListener(new SmsListener() {
            ...
            public void messageReceived(String messageText) {
                ...
                {
                    final String result = messageText.substring(messageText.indexOf("[") + 1, messageText.indexOf("]"));
                    verify(result,phone);
    ...
    public void verify(final String code, final String phone){
